...
const JobExperiences = () => {
  return (
    <div>
      ...
      <p>
        BRICKX is a company based in Australia but it was a startup at the time I joined them.<br/>
        I worked with them during my entire permanence in Sydney,  almost two years. From February 2016 to December 2017.<br/>
        Here I had a great experience, both personal and professional.
      ...
      <p>
        ...
        This is because each property is bought and the value divided into 10 thousand parts, which are the shares that users are going to own. They will resell them to other users of the platform, when is more convenient.<br/>
      ...
      <p>
        I have worked with BRICKX as software engineer. I took care of both the back-end and the front-end of one of the micro services.<br/>
        ...
        The language in use for the back end was Scala with Play Framework.
      </p>
      ...
      <p>
        ...
        The programming language in use was Scala with Liftweb Framework.
